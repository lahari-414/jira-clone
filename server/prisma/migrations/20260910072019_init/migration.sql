-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'PROJECT_MANAGER', 'DEVELOPER', 'TESTER', 'VIEWER');
...
-- CreateEnum
CREATE TYPE "IssueType" AS ENUM ('TASK', 'BUG', 'STORY', 'EPIC', 'IMPROVEMENT');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ASSIGNED', 'STATUS_CHANGED', 'MENTIONED', 'COMMENTED', 'SPRINT_STARTED', 'SPRINT_COMPLETED');
...
CREATE TABLE "ProjectMember" (
    ...
    "projectRole" "ProjectMemberRole" NOT NULL DEFAULT 'MEMBER',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
